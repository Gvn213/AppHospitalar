...
public class codigocanceladas extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_CC").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_CC")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refcanceladas = appleSnapshot.getRef().child("canceladas");
                                                            refcanceladas.setValue(contagem.getCanceladas() - 1);
                                                        }
                                                    }
                                                }
