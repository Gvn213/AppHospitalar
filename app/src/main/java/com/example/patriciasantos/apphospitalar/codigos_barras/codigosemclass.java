...
public class codigosemclass extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_SC").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_SC")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refsemclass = appleSnapshot.getRef().child("semclass");
                                                            refsemclass.setValue(contagem.getSemclass() - 1);
                                                        }
                                                    }
                                                }
