...
public class codigodesistencia extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_DT").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_DT")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refdesistencia = appleSnapshot.getRef().child("desistencia");
                                                            refdesistencia.setValue(contagem.getDesistencia() - 1);
                                                        }
                                                    }
                                                }
