...
public class codigocirurgico extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_CR").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_CR")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refcirurgico = appleSnapshot.getRef().child("cirurgico");
                                                            refcirurgico.setValue(contagem.getCirurgico() - 1);
                                                        }
                                                    }
                                                }
