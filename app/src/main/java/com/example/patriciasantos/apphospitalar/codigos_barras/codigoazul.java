...
public class codigoazul extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_AZ").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_AZ")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refazul = appleSnapshot.getRef().child("azul");
                                                            refazul.setValue(contagem.getAzul() - 1);
                                                        }
                                                    }
                                                }
