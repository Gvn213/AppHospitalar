...
public class codigodesaparecidas extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_DS").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_DS")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refdesaparecidas = appleSnapshot.getRef().child("desaparecidas");
                                                            refdesaparecidas.setValue(contagem.getDesaparecidas() - 1);
                                                        }
                                                    }
                                                }
