...
public class codigovermelha extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_VM").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_VM")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refvermelha = appleSnapshot.getRef().child("vermelha");
                                                            refvermelha.setValue(contagem.getVermelha() - 1);
                                                        }
                                                    }
                                                }
