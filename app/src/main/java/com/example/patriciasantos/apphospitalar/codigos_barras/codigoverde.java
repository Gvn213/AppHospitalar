...
public class codigoverde extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_VR").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_VR")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refverde = appleSnapshot.getRef().child("verde");
                                                            refverde.setValue(contagem.getVerde() - 1);
                                                        }
                                                    }
                                                }
