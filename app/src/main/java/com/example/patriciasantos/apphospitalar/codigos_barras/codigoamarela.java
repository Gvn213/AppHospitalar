...
public class codigoamarela extends AppCompatActivity {
    ...
    public void carregarListView() {
        ...
        reference.orderByChild("fichainfo").equalTo(data + "_AM").
        ...
        myRef.orderByChild("fichainfo").equalTo(data + "_AM")
                                                ...
                                                public void onDataChange(final DataSnapshot dataSnapshot) {
                                                    if (dataSnapshot.exists()) {
                                                        for (DataSnapshot appleSnapshot : dataSnapshot.getChildren()) {
                                                            ...
                                                            DatabaseReference refamarela = appleSnapshot.getRef().child("amarela");
                                                            refamarela.setValue(contagem.getAmarela() - 1);
                                                        }
                                                    }
                                                }
